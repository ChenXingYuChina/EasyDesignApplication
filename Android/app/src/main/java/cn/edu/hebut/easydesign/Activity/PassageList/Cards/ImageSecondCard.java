...
public class ImageSecondCard extends PassageItemCard {
    ...
    public ImageSecondCard(@NonNull Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.image_second_card_frame, this);
