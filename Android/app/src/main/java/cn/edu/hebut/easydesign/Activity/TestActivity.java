        ...
        connection = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    ComplexString ld = ComplexStringLoader.getInstance().LoadFromNet(description);
                    page.setLongDescription(new UserDescriptionPage.userFull(new User(user), ld));
                    TestActivity.this.setContentView(page.getView());
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
