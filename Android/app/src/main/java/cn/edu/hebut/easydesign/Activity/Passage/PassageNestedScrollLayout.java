...
public class PassageNestedScrollLayout
        extends LinearLayout implements NestedScrollingParent {
    PassageNestedScrollParentHelper helper;

    public PassageNestedScrollLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onFinishInflate() {
        ...
        helper = new PassageNestedScrollParentHelper(this);
    }
